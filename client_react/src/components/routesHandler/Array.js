...
class Array extends Component {
  ...
  onSubmitPost(e) {
    axios
      .post(
        `http://localhost:5000/arr/add/${this.state.length}/${this.state.size}`
      )
  ...
  onSubmitUpdate(e) {
    ...
    axios
      .put(
        `http://localhost:5000/arr/update/${this.state.updateId}/${this.state.length}/${this.state.size}`
      )
      .then((res) => console.log(res.data));
  }
  onSubmitDelete(e) {

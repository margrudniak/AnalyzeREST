...
class Object extends Component {
  ...
  onSubmitPost(e) {
    axios
      .post(
        `http://localhost:5000/obj/add/${this.state.length}/${this.state.size}`
      )
  ...
  onSubmitUpdate(e) {
    ...
    axios
      .put(
        `http://localhost:5000/obj/update/${this.state.updateId}/${this.state.length}/${this.state.size}`
      )
      .then((res) => console.log(res.data));
  }
  onSubmitDelete(e) {

...
class ArrObj extends Component {
  constructor(props) {
    super(props);
    this.state = {
      length: "",
  ...
  onSubmitPost(e) {
    axios
      .post(
        `http://localhost:5000/arrObj/add/${this.state.length}/${this.state.size}`
      )
  ...
  onSubmitUpdate(e) {
    ...
    axios
      .put(
        `http://localhost:5000/arrObj/update/${this.state.updateId}/${this.state.length}/${this.state.size}`
      )
      .then((res) => console.log(res.data));
  }
  onSubmitDelete(e) {
            ...
            <Col>
              ...
              <form onSubmit={this.onSubmitPost}>
                <label>
                  ...
                  />
                  <p>Ilości elementów oraz atrybutów: </p>
                  <input
                    type="text"
